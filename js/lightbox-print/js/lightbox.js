...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = 'js/lightbox-print/images/loading.gif';
      this.fileCloseImage = 'js/lightbox-print/images/close.png';
      this.filePrintImage = 'js/lightbox-print/images/print.png';
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
      /*maxi*/
      if (imageWidth > 700) {
        //imageHeight = imageHeight / imageWidth * 800;
        imageHeight = 500;
        imageWidth = 700;
        }
      //maxi
      ...
      setTimeout(function() {
        $lightbox.find('.lb-dataContainer').width(290);
