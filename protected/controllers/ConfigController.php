...
class ConfigController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','DeleteCaching'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Config']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idconfig));
		}
	...
	public function actionDeleteCaching()
	{
		...
		$dir_2 ="/var/www/xxxx/assets/";
		$handle = opendir($dir_2);
		while ($file = readdir($handle))
		{
			var_dump($dir_2.$file);
			if (is_file($dir_2.$file))
			{
			unlink($dir_2.$file);
			}
		}
