...
if (class_exists('TCPDF', false)) {
    require('protected/extensions/FPDI-1.4.2/fpdi2tcpdf_bridge.php');
}

require('protected/extensions/FPDI-1.4.2/fpdf_tpl.php');
require('protected/extensions/FPDI-1.4.2/fpdi_pdf_parser.php');
